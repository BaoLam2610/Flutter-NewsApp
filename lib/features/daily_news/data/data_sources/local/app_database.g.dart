...
class _$ArticleDao extends ArticleDao {
  ...
  @override
  Future<void> insertArticle(ArticleModel data) async {
    await _articleModelInsertionAdapter.insert(data, OnConflictStrategy.ignore);
  }

  @override
  Future<void> deleteArticle(ArticleModel data) async {
    await _articleModelDeletionAdapter.delete(data);
  }
}
